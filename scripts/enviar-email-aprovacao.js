...
console.log('📧 Enviando e-mail de boas-vindas para inscrição aprovada...');
...
// Dados do e-mail (MODIFIQUE ESTES DADOS COM OS DADOS REAIS DA INSCRIÇÃO)
const dadosInscricao = {
  destinatario: 'contacto.aguia@gmail.com', // ⚠️ MODIFIQUE: Email real do cooperado
  nome_cooperado: 'João Silva', // ⚠️ MODIFIQUE: Nome real do cooperado
  numero_associado: 'CS123456', // ⚠️ MODIFIQUE: Número gerado pelo sistema
  senha_temporaria: 'ABC12345', // ⚠️ MODIFIQUE: Senha gerada pelo sistema
  nome_plano: 'Plano Básico', // ⚠️ MODIFIQUE: Plano escolhido
