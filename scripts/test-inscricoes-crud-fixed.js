...
async function testInscricoesCRUDFixed() {
  console.log('🧪 Testando CRUD corrigido das Inscrições...\n')
  ...
  try {
      ...
      if (inscricaoParaAprovar) {
        ...
        if (updateError) {
          ...
          const cooperadoData = {
            ...
            documentos_urls: inscricaoParaAprovar.documentos_anexados ? Object.values(inscricaoParaAprovar.documentos_anexados).filter(url => url) : [],
    ...
    console.log('\n🎉 Teste CRUD corrigido concluído!')
