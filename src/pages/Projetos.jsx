...
import GerenciadorInscricoesProjetos from "../components/admin/GerenciadorInscricoesProjetos";
...
export default function Projetos() {
  ...
  const [modoAtivo, setModoAtivo] = useState("projetos"); // "projetos" ou "inscricoes"
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <div className="flex bg-slate-100 rounded-lg p-1">
            <Button
              variant={modoAtivo === "projetos" ? "default" : "ghost"}
              size="sm"
              onClick={() => setModoAtivo("projetos")}
            ...
            <Button
              variant={modoAtivo === "inscricoes" ? "default" : "ghost"}
              size="sm"
              onClick={() => setModoAtivo("inscricoes")}
              className="flex items-center gap-2"
            >
