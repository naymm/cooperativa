...
export default function PortalInscricaoProjetos() {
  ...
  const carregarDados = async (id) => {
    ...
    try {
      const [projetos, inscricoes] = await Promise.all([
        ...
        inscricaoProjetoService.buscarInscricoesCooperado(id)
      ]);
    ...
    <PortalLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button onClick={() => carregarDados(cooperadoId)} variant="outline">
